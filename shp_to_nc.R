...
fr_8km_dep=lapply(fr_8km_dep,function(x) drop(as.array(x)))
fr_8km_dep=abind(fr_8km_dep,along = 3)
fr_8km_dep=aperm(fr_8km_dep, c(2,1,3))
...
fr_8km_reg_hyd=lapply(fr_8km_reg_hyd,function(x) drop(as.array(x)))
fr_8km_reg_hyd=abind(fr_8km_reg_hyd,along = 3)
fr_8km_reg_hyd=aperm(fr_8km_reg_hyd, c(2,1,3))
