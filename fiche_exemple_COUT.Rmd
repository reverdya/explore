...
```{r rawtime, fig.cap="Valeurs simulées du module annuel de la Seine à Poses au cours du temps pour les différentes combinaisons GCM/RCM disponibles pour le RCP 8.5 entre 1972 et 2098 (période commune des modèles)."}
