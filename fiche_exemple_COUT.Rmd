...
```{r mapiv,dpi=300, fig.cap="Carte de l'incertitude (écart-type) liée à la variabilité interne du module annuel de débit pour la France métropolitaine. Points à l'exutoire."}

map_iv

```

```{r mappart,dpi=300, fig.cap="Carte de la partition de variance pour la France métropolitaine. Points à l'exutoire."}
...
```{r mapgcmeff,dpi=300, fig.height = 20/2.54/1.7, fig.cap="Carte des effets principaux des GCMs pour le module annuel de débit sur la France métropolitaine en 2050, par rapport à la référence 1990. Points à l'exutoire."}
...
```{r mapgcmch,dpi=300, fig.height = 20/2.54/1.7, fig.cap="Carte des changements relatifs pour le module annuel de débit en fonction du GCM sur la France métropolitaine en 2050, par rapport à la référence 1990. Les valeurs sont les moyennes d'ensemble complet pour un GCM donné. Points à l'exutoire."}
